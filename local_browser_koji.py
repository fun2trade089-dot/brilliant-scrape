...
def run():
    ...
    with sync_playwright() as p:
        print("[>>] Launching Microsoft Edge with your local profile...")

        # launch_persistent_context uses your REAL Edge profile
        # (all cookies, localStorage, login sessions included)
